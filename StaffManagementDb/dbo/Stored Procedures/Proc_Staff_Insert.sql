...
@Name VARCHAR (50)=NULL, @Phone VARCHAR (30)=NULL, @Email VARCHAR (30)=NULL, @Address VARCHAR (10)=NULL, @Roles NVARCHAR (30), @Privelage NVARCHAR (50)=NULL, @Position NVARCHAR (50)=NULL,@Experience int=NULL, @Designation NVARCHAR (50)=NULL
AS
BEGIN
    SET NOCOUNT ON;
    SET XACT_ABORT ON;
    ...
    INSERT INTO Teacher
	SELECT @EmpID, @Experience FROM Staff WHERE StaffId = @EmpId AND @Roles = 'Teacher';
    COMMIT TRANSACTION;
END